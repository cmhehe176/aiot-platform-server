...
export class RefactorMigration1734535990740 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "sub_device" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "created_id" integer, "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_id" integer, "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "unit" character varying, "type" character varying NOT NULL DEFAULT 'sensor', "description" character varying, "limit" character varying, "device_id" integer, "permissions" jsonb, "publish" boolean NOT NULL DEFAULT true, CONSTRAINT "PK_cff43d098913c561c82c67292ee" PRIMARY KEY ("id"))`);
